...
const KEYWORDS = ['val', 'fn', 'if', 'else', 'const', 'and', 'or', 'elif','do','end','true','false'];
...
module.exports = {isDigit, isValidIdentifierCharacter, isValidStartOfIdentifierCharacter, checkIdType}